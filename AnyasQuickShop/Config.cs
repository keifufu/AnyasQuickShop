...
namespace AnyasQuickShop
{
    public class Config
    {
        public const string ModName = "AnyasQuickShop";
        private const string ConfigCategoryName = "AnyasQuickShop";

        // Config
        public KeyCode BuyKeyCode => _buyKeyCode.Value;
        public KeyCode BuyTunedKeyCode => _buyTunedKeyCode.Value;
        public KeyCode UnmountAllBodyPartsKeyCode => _unmountAllBodyPartsKeyCode.Value;
        ...
        private readonly MelonPreferences_Entry<KeyCode> _unmountAllBodyPartsKeyCode;
        ...
        public Config()
        {
            ...
            _config.SetFilePath("Mods/AnyasQuickShop.cfg");
            ...
            _unmountAllBodyPartsKeyCode = _config.CreateEntry(nameof(UnmountAllBodyPartsKeyCode), KeyCode.Delete);
            ...
            // Parts
            if (!File.Exists("Mods/AnyasQuickShop_parts.json"))
                CreatePartsFile();
            string jsonString = File.ReadAllText("Mods/AnyasQuickShop_parts.json");
        ...
        private void CreatePartsFile()
        {
            ...
            using (var file = File.CreateText("Mods/AnyasQuickShop_parts.json"))
            {
